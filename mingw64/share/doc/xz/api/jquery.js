 ...
 * Copyright jQuery Foundation and other contributors; Licensed MIT */ !(function (
  ...
  (y.cleanData =
    ...
    (y.widget = function (t, i, e) {
      ...
      return (
        e || ((e = i), (i = y.Widget)),
        Array.isArray(e) && (e = y.extend.apply(null, [{}].concat(e))),
        (y.expr.pseudos[r.toLowerCase()] = function (t) {
          return !!y.data(t, r);
        }),
        (y[a] = y[a] || {}),
        (s = y[a][t]),
        ...
        ((o = new i()).options = y.widget.extend({}, o.options)),
        ...
        s
          ? (y.each(s._childConstructors, function (t, e) {
              var i = e.prototype;
              y.widget(i.namespace + "." + i.widgetName, n, e._proto);
            }),
    ...
    (y.Widget.prototype = {
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((o = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              s = o[t] = y.widget.extend({}, this.options[t]), n = 0;
              n < i.length - 1;
              n++
            )
              (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
      ...
      _classes: function (n) {
        ...
        function t(t, e) {
          for (var i, s = 0; s < t.length; s++)
            (i = h.classesElementLookup[t[s]] || y()),
              (i = n.add
                ? ((function () {
                    var i = [];
                    n.element.each(function (t, e) {
                      y
                        .map(h.classesElementLookup, function (t) {
                          return t;
                        })
                        .some(function (t) {
                          return t.is(e);
                      ...
                      h._on(y(i), { remove: "_untrackClassesElement" });
                  })(),
                  y(y.uniqueSort(i.get().concat(n.element.get()))))
                : y(i.not(n.element).get())),
              (h.classesElementLookup[t[s]] = i),
              o.push(t[s]),
      ...
      _untrackClassesElement: function (i) {
        ...
        y.each(s.classesElementLookup, function (t, e) {
          -1 !== y.inArray(i.target, e) &&
            (s.classesElementLookup[t] = y(e.not(i.target).get()));
        }),
      ...
      _on: function (n, o, t) {
        ...
        "boolean" != typeof n && ((t = o), (o = n), (n = !1)),
          t
            ? ((o = h = y(o)), (this.bindings = this.bindings.add(o)))
            : ((t = o), (o = this.element), (h = this.widget())),
          y.each(t, function (t, e) {
            ...
            "string" != typeof e &&
              (i.guid = e.guid = e.guid || i.guid || y.guid++);
            var s = t.match(/^([\w:-]*)\s*(.*)$/),
              t = s[1] + a.eventNamespace,
              s = s[2];
            s ? h.on(t, s, i) : o.on(t, i);
          });
      },
      _off: function (t, e) {
        (e =
    ...
    y.each({ show: "fadeIn", hide: "fadeOut" }, function (o, h) {
      y.Widget.prototype["_" + o] = function (e, t, i) {
        var s,
          n = (t = "string" == typeof t ? { effect: t } : t)
            ? (!0 !== t && "number" != typeof t && t.effect) || h
            : o;
        "number" == typeof (t = t || {})
          ? (t = { duration: t })
          : !0 === t && (t = {}),
          ...
          s && y.effects && y.effects.effect[n]
            ? e[o](t)
            : n !== o && e[n]
  ...
  (x = Math.max),
    ...
    (y.position = {
      ...
      getWithinInfo: function (t) {
        ...
        return {
          ...
          isWindow: i,
          isDocument: s,
          offset: !i && !s ? y(t).offset() : { left: 0, top: 0 },
    ...
    (y.fn.position = function (p) {
      if (!p || !p.of) return W.apply(this, arguments);
      var d,
        c,
        f,
        g,
        ...
        t,
        _ =
          "string" == typeof (p = y.extend({}, p)).of
            ? y(document).find(p.of)
            : y(p.of),
        w = y.position.getWithinInfo(p.within),
        v = y.position.getScrollInfo(w),
        b = (p.collision || "flip").split(" "),
        z = {},
        e =
          9 === (t = (e = _)[0]).nodeType
            ? {
      ...
      return (
        _[0].preventDefault && (p.at = "left top"),
        (c = e.width),
        (f = e.height),
        (m = y.extend({}, (g = e.offset))),
        y.each(["my", "at"], function () {
          ...
          ((i =
            ...
            (t = l.exec(i[0])),
            (e = l.exec(i[1])),
            (z[this] = [t ? t[0] : 0, e ? e[0] : 0]),
            (p[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]);
        }),
        1 === b.length && (b[1] = b[0]),
        "right" === p.at[0]
          ? (m.left += c)
          : "center" === p.at[0] && (m.left += c / 2),
        "bottom" === p.at[1]
          ? (m.top += f)
          : "center" === p.at[1] && (m.top += f / 2),
        (d = E(z.at, c, f)),
        (m.left += d[0]),
        (m.top += d[1]),
        this.each(function () {
          var i,
            ...
            e = H(this, "marginLeft"),
            s = H(this, "marginTop"),
            n = a + e + H(this, "marginRight") + v.width,
            o = r + s + H(this, "marginBottom") + v.height,
            l = y.extend({}, m),
            u = E(z.my, h.outerWidth(), h.outerHeight());
          "right" === p.my[0]
            ? (l.left -= a)
            : "center" === p.my[0] && (l.left -= a / 2),
            "bottom" === p.my[1]
              ? (l.top -= r)
              : "center" === p.my[1] && (l.top -= r / 2),
            (l.left += u[0]),
            (l.top += u[1]),
            (i = { marginLeft: e, marginTop: s }),
            y.each(["left", "top"], function (t, e) {
              y.ui.position[b[t]] &&
                y.ui.position[b[t]][e](l, {
                  targetWidth: c,
                  targetHeight: f,
                  elemWidth: a,
                  elemHeight: r,
            ...
            p.using &&
              (t = function (t) {
                ...
                c < a && D(e + i) < c && (o.horizontal = "center"),
                  f < r && D(s + n) < f && (o.vertical = "middle"),
                  x(D(e), D(i)) > x(D(s), D(n))
                    ? (o.important = "horizontal")
                    : (o.important = "vertical"),
                  p.using.call(this, t, o);
              }),
            h.offset(y.extend(l, { using: t }));
        })
      );
    }),
    (y.ui.position = {
      fit: {
        left: function (t, e) {
          ...
          e.collisionWidth > n
            ? 0 < h && a <= 0
              ? ((i = t.left + h + e.collisionWidth - n - s), (t.left += h - i))
              : (t.left =
                  !(0 < a && h <= 0) && a < h ? s + n - e.collisionWidth : s)
            : 0 < h
              ? (t.left += h)
              : 0 < a
                ? (t.left -= a)
        ...
        top: function (t, e) {
          ...
          e.collisionHeight > n
            ? 0 < h && a <= 0
              ? ((i = t.top + h + e.collisionHeight - n - s), (t.top += h - i))
              : (t.top =
                  !(0 < a && h <= 0) && a < h ? s + n - e.collisionHeight : s)
            : 0 < h
              ? (t.top += h)
              : 0 < a
                ? (t.top -= a)
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[0];
          a < 0
            ? ((s = t.left + l + i + h + e.collisionWidth - n - s) < 0 ||
                s < D(a)) &&
              (t.left += l + i + h)
            : 0 < r &&
              (0 <
                (o = t.left - e.collisionPosition.marginLeft + l + i + h - o) ||
                D(o) < r) &&
              (t.left += l + i + h);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[1];
          a < 0
            ? ((s = t.top + l + i + h + e.collisionHeight - n - s) < 0 ||
                s < D(a)) &&
              (t.top += l + i + h)
            : 0 < r &&
              (0 <
                (o = t.top - e.collisionPosition.marginTop + l + i + h - o) ||
                D(o) < r) &&
              (t.top += l + i + h);
        },
      },
    ...
    return "area" === h
      ? ((s = (i = t.parentNode).name),
        !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) &&
          0 < (s = y("img[usemap='#" + s + "']")).length &&
          s.is(":visible"))
      : (/^(input|select|textarea|button|object)$/.test(h)
          ? (n = !t.disabled) &&
            (o = y(t).closest("fieldset")[0]) &&
            (n = !o.disabled)
          : (n = ("a" === h && t.href) || e),
        n &&
          y(t).is(":visible") &&
  ...
  y.expr.pseudos || (y.expr.pseudos = y.expr[":"]),
    y.uniqueSort || (y.uniqueSort = y.unique),
    y.escapeSelector ||
        ...
        ? this[0].labels && this[0].labels.length
          ...
          : ((e = this.eq(0).parents("label")),
            (t = this.attr("id")) &&
              ...
              (t = "label[for='" + y.escapeSelector(t) + "']"),
        ...
        return i && !s && this._mouseCapture(t)
          ? ((this.mouseDelayMet = !this.options.delay),
            ...
            !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 ===
                  y.data(t.target, this.widgetName + ".preventClickEvent") &&
                  y.removeData(
                    t.target,
  ...
  y.widget("ui.resizable", y.ui.mouse, {
    ...
    _create: function () {
      ...
      this._addClass("ui-resizable"),
        ...
        this.element[0].nodeName.match(
          ...
          (this.element.wrap(
            y("<div class='ui-wrapper'></div>").css({
              overflow: "hidden",
        ...
        for (e in ((t = t || this.element), this.handles))
          this.handles[e].constructor === String
            ...
            : (this.handles[e].jquery || this.handles[e].nodeType) &&
              ((this.handles[e] = y(this.handles[e])),
              this._on(this.handles[e], { mousedown: h._mouseDown })),
            this.elementIsWrapper &&
    ...
    _mouseCapture: function (t) {
      ...
      for (e in this.handles)
        ((i = y(this.handles[e])[0]) !== t.target &&
          !y.contains(i, t.target)) ||
          (s = !0);
    ...
    _mouseStart: function (t) {
      ...
      return (
        ...
        s.containment &&
          ((e += y(s.containment).scrollLeft() || 0),
          (i += y(s.containment).scrollTop() || 0)),
    ...
    _mouseStop: function (t) {
      ...
      return (
        this._helper &&
          ...
          n.animate || this.element.css(y.extend(e, { top: s, left: i })),
    ...
    _respectSize: function (t) {
      ...
      return (
        ...
        h && (t.height = e.minHeight),
        s && (t.width = e.maxWidth),
        n && (t.height = e.maxHeight),
        o && l && (t.left = a - e.minWidth),
        s && l && (t.left = a - e.maxWidth),
        h && i && (t.top = r - e.minHeight),
        n && i && (t.top = r - e.maxHeight),
    ...
    _renderProxy: function () {
      ...
      (this.elementOffset = t.offset()),
        this._helper
          ? ((this.helper =
              this.helper || y("<div></div>").css({ overflow: "hidden" })),
    ...
    _propagate: function (t, e) {
      y.ui.plugin.call(this, t, [e, this.ui()]),
    ...
    y.ui.plugin.add("resizable", "animate", {
      stop: function (e) {
        var i = y(this).resizable("instance"),
          ...
          n = { width: i.size.width - h, height: i.size.height - o },
          h =
        ...
        i.element.animate(y.extend(n, o && h ? { top: o, left: h } : {}), {
          ...
          step: function () {
            ...
            s && s.length && y(s[0]).css({ width: t.width, height: t.height }),
              i._updateCache(t),
    ...
    y.ui.plugin.add("resizable", "containment", {
          ...
          /document/.test(o) || o === document
            ? ((n.containerOffset = { left: 0, top: 0 }),
              ...
              (n.parentData = {
                ...
                height:
                  y(document).height() || document.body.parentNode.scrollHeight,
              }))
            : ((i = y(h)),
              (s = []),
              ...
              (o = n._hasScroll(h, "left") ? h.scrollWidth : o),
              (e = n._hasScroll(h) ? h.scrollHeight : e),
              (n.parentData = {
                element: h,
                left: t.left,
                top: t.top,
      ...
      resize: function (t) {
        var e = y(this).resizable("instance"),
          ...
          t = !0;
        a[0] !== document && /static/.test(a.css("position")) && (h = s),
          ...
          (n = Math.abs(
            e.sizeDiff.width +
              (e._helper ? e.offset.left - h.left : e.offset.left - s.left),
          )),
          (s = Math.abs(
            e.sizeDiff.height +
              (e._helper ? e.offset.top - h.top : e.offset.top - s.top),
          )),
      ...
      stop: function () {
        ...
        t._helper &&
          ...
          y(this).css({ left: h.left - s.left - i.left, width: a, height: o }),
          t._helper &&
            !e.animate &&
    ...
    y.ui.plugin.add("resizable", "grid", {
      resize: function () {
        var t,
          ...
          p = Math.round((s.height - n.height) / l) * l,
          d = n.width + u,
          c = n.height + p,
          f = i.maxWidth && i.maxWidth < d,
          g = i.maxHeight && i.maxHeight < c,
        ...
        (i.grid = a),
          ...
          g && (c -= l),
          /^(se|s|e)$/.test(h)
            ? ((e.size.width = d), (e.size.height = c))
            : /^(ne)$/.test(h)
              ? ((e.size.width = d),
                (e.size.height = c),
                (e.position.top = o.top - p))
              : /^(sw)$/.test(h)
                ? ((e.size.width = d),
                  (e.size.height = c),
                  (e.position.left = o.left - u))
                : ((c - l <= 0 || d - r <= 0) &&
                    (t = e._getPaddingPlusBorderDimensions(this)),
                  0 < c - l
                    ? ((e.size.height = c), (e.position.top = o.top - p))
                    : ((c = l - t.height),
                      (e.size.height = c),
